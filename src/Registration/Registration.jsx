        ...
        <div className="vertical-centered">
            <div className="registration">
                ...
                <Form.Group controlId="formUserName" className="my-3">
                    ...
                    <Form.Control as="select" size="lg" custom className="p-2 fullWidth" onChange={(e)=>{
...

                    {
                        teacher&&<div>
                            <Form.Group controlId="Department" className="my-3">
                                <Form.Control type="text" placeholder="Department" value={department}
                                onChange={(e)=>setDepartment(e.target.value)}/>                    
                            </Form.Group>                
                            <Form.Group controlId="Faculty" className="my-3">
                                <Form.Control type="text" placeholder="Faculty" value={faculty}
                    ...
                    <Button variant="success" type="button" className="mx-2"
                        onClick={async()=>{
                            ...
                            try{
                                let value = await register(userName,password,department,faculty,role)
                                if(value === true){
                                    history.push("login")
                                }
                            }
